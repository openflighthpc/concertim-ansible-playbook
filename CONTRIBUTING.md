# Contributing to Concertim Ansible Playbook

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Concertim Ansible Playbook? Welcome! Please read this
...
You can help Concertim Ansible Playbook by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/concertim-ansible-playbook/issues?state=open)
...
If you find a bug - behaviour of Concertim Ansible Playbook code or documentation
...
[GitHub issue tracker for Concertim Ansible Playbook](https://github.com/openflighthpc/concertim-ansible-playbook/issues/new)
to report the issue.
...
We want to improve the quality of Concertim Ansible Playbook and good bug reports are
...
Concertim Ansible Playbook is Open Source and comes without warranty.
...
Concertim Ansible Playbook in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Concertim Ansible Playbook and really improve it. The more
...
applied to Concertim Ansible Playbook itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/concertim-ansible-playbook). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Concertim Ansible Playbook developers also have their regular
